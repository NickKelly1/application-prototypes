...
const setup = (total, products = []) => {
  ...
  const component = shallow(
    <CartComponent products={products} total={total} {...actions} />
  );
  ...
  return {
    ...
    products: component.find(ProductComponent),
...
describe('Cart component', () => {
  ...
  it('should display add some products message', () => {
    const { em } = setup();
    expect(em.text()).toMatch(/^Please add some products to the cart/);
  });

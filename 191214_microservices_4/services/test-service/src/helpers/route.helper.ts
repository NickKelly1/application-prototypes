...
import { A_HTTP_STATUS, HTTP_STATUS } from '../shared/ts/constants/http-status.constant';
...
export type RequestFail = { code: A_HTTP_STATUS; message: string; data: {} }


export function mapFail(code: A_HTTP_STATUS, message: string, data = {}) {
